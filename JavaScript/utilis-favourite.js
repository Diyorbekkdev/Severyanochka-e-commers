...
function getProductCardd(
    ...
    <img
      ...
      alt="${name}"
    />
    <label  ${checkFavorite ? `checked="checked"` : `cheked = "j"`} class="container__heart">
      <input onclick="addToFavourite(${id}, '${which}')" checked = "checked" type=" ${checkFavorite ? `checkbox` : `j`}" />
      <div class="checkmark">
